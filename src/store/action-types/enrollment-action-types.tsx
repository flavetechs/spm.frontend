export const actions = {
    ...
    RETURN_ENROLLED_STUDENT_LIST: "RETURN_ENROLLED_STUDENT_LIST",
    RESET_ENROLLED_STUDENTS_STATE:"RESET_ENROLLED_STUDENTS_STATE",
    ...
    SHOW_HIDE_CLASS_MODAL: "SHOW_HIDE_CLASS_MODAL",
}