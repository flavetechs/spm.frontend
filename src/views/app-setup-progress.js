...
const AppSetupProgress = () => {
  ...
  return (
    <>
            <div className="overflow-hidden card aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                  ...
                  <div className="mt-4 table-responsive">
                     <table id="basic-table" className="table mb-0 table-striped" role="grid">
                       ...
                       {appSetupStatus?.map((status,idx)=>(
                           ...
                           <path fill="#25d100" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"></path>
                        </svg>}
                              </td>
