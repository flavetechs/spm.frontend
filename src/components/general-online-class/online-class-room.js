    ...
    <>
      <header id="nav">
        <div className="nav--list">
          <button
            id="members__button"
            onClick={() => setToggleMemberDisplay(!toggleMemberDisplay)}
          >
            <svg
              width="24"
              height="24"
          ...
          <h3 id="logo">
            <img
              src="https://t4.ftcdn.net/jpg/03/16/32/23/240_F_316322355_m8FC5EDRun5JOAAHD94CvW1uUScY5IFh.jpg"
              alt="Site Logo"
            />
            <span>GoChat</span>
          </h3>
        ...
        <div id="nav__links">
          <button
            id="chat__button"
            onClick={() => setToggleChatDisplay(!toggleChatDisplay)}
          >
            <svg
              width="24"
              height="24"
      ...
      <main className="general__container">
        <div id="room__container">
          <section
            ...
            style={{ display: toggleMemberDisplay ? "block" : "none" }}
          >
          ...
          <section
            ...
            style={{ display: toggleChatDisplay ? "block" : "none" }}
          >
            <div id="messages" ref={messagesContainerRef}></div>

            <form
              id="message__form"
              onSubmit={(e) => sendMessage(e, textValue, setTextValue)}
            >
              <input
                type="text"
                value={textValue}
