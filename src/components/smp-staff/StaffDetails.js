                                ...
                                <Card>
                                    <Card.Header className="d-flex justify-content-between">
                                        <div className="header-title">
                                            <h4 className="card-title">Staff Photo</h4>
                                        </div>
                                    </Card.Header>
                                    <Card.Body>
                                        <div>
                                        ...
                                        <div className="new-user-info">
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex justify-content-end">
                                                    ...
                                                    onClick={() => {
                                                        fetchSingleItem(selectedItem?.teacherAccountId)(dispatch)
                                                        history.push(`${staffLocations.staffEdit}?teacherAccountId=${selectedItem?.teacherAccountId}`);
                                                      }
                                                      } 
                                                    >Edit Details</Button>
                                                </div>
