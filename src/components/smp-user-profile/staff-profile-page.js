...
const StaffProfilePage = () => {
    ...
    let profilePhoto = "https://media.istockphoto.com/photos/millennial-male-team-leader-organize-virtual-workshop-with-employees-picture-id1300972574?k=20&m=1300972574&s=612x612&w=0&h=kndUxGzi4W9gD_s-3Jq2vd9wxv2Qn2EEtZ7qjce1nhY=";
    //VARIABLE DECLARATIONS
                    ...
                    <Card>
                        ...
                        <div className="card-body ">
                            <div>
                                ...
                                <h5 className="d-flex justify-content-center text-dark">Okey John Ben</h5><hr className="fw-bold" />
                                <p className=""><span>Status: </span>{" "}
                                    <span className="text-dark fwd-bold ps-2"><b>Teacher</b></span></p>
                      ...
                      <p> <span>Middle Name:</span><span className="h6 text-capitalize"> {selectedStudent?.middleName}</span></p>
                                        ...
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Mobile Number:</span> <span className="h6">08057494883</span></p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span>Home Phone Number:</span> <span className="h6">07057494883</span></p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span className="h6"> {selectedStudent?.emergencyPhone}+234707898933</span>
                                            </p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Email Address:</span> <span className="h6 text-capitalize">okeyJohn@gmail.com</span></p>
                                        </div>
                                        <div className="col-md-6  form-group">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span>Date Of Birth:</span> <span className="h6">20th Jan 1987</span></p>
                                        </div>
                                        <div className="col-sm-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Home Address:</span> <span className="h6 text-capitalize"> {selectedStudent?.homeAddress} Igwuruta lekki phase 2</span></p>
                                        </div>
                                        <div className="col-md-6  form-group">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span>City:</span> <span className="h6 text-capitalize"> {selectedStudent?.cityId} Island City</span></p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                <span>
                                        ...
                                        <div className="col-md-6 form-group text-capitalize">
                                            <p className="text-dark">
                                                ...
                                                <span>Country:</span><span className="h6 text-capitalize"> {selectedStudent?.countryId}Nigeria</span></p>
                                        </div>
                                        <div className="col-md-6 form-group text-capitalize">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span>Zip Code:</span> <span className="h6"> {selectedStudent?.zipCode}100010</span></p>
                                        </div>
                                    </div>
                                    <hr />
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Name:</span> <span className="h6 text-capitalize"> {selectedStudent?.parentOrGuardianName}Okey Jane</span></p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                <span>
                                                ...
                                                <span className="h6 text-capitalize"> {selectedStudent?.parentOrGuardianRelationship}Wife</span>
                                            </p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Mobile Number:</span> <span className="h6"> {selectedStudent?.parentOrGuardianPhone}08038474944</span>
                                            </p>
                                        </div>
                                        <div className="col-md-6 form-group">
                                            <p className="text-dark">
                                                ...
                                                <span>Email Address:</span> <span className="h6"> {selectedStudent?.parentOrGuardianEmail}janneo@gmail.com</span>
                                            </p>
                                        </div>
                                    </div>
