...
const AdminDashboard = (props) => {
    ...
    // console.log('dashboardCount now:', dashboardCount);
    // ACCESSING STATE FROM REDUX STORE
                                    ...
                                    <div className="card-body">
                                        <div className="progress-widget" >
                                            ...
                                            <div className="progress-detail">
                                                ...
                                                <h4 className="counter"><CountUp start={1} end={40} duration={3} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className=" card card-slide" >
                                    <div className="card-body">
                                        <div className="progress-widget">
                                            ...
                                            <div className="progress-detail">
                                                <p className="mb-2">Staff No.</p>

                                                <h4 className="counter"><CountUp start={0} end={158} duration={3} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                    ...
                                    <div className="card-body">
                                        <div className="progress-widget">
                                            ...
                                            <div className="progress-detail">
                                                ...
                                                <h4 className="counter"><CountUp start={0} end={78} duration={3} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                    ...
                                    <div className="card-body">
                                        <div className="progress-widget">
                                            ...
                                            <div className="progress-detail">
                                                ...
                                                <h4 className="counter"><CountUp start={1} end={142} duration={3} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
                                    ...
                                    <div className="card-body">
                                        <div className="progress-widget">
                                            ...
                                            <div className="progress-detail">
                                                ...
                                                <h4 className="counter"><CountUp start={1} end={1150} duration={3} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
