                          ...
                          <td className="h2 text-center">
                            ...
                            >
                              <Link
                                ...
                                onClick={() => {
                                  history.push(
                                    sessionLocations.promotionPassedList
                                  );
                                }}
                              >
                          ...
                          <td className="h4 text-center">
                            ...
                            >
                              <Link
                                ...
                                onClick={() => {
                                  history.push(
                                    sessionLocations.promotionFailedList
                                  );
                                }}
                              >
                          ...
                          <td className="h5 text-center">
                            <div className="form-group">
                              ...
                              >
                                ...
                                {promoteList
                                  .slice(idx + 1, promoteList.length)
                                  .map((list, idx) => (
                                    <option key={idx} value={list.prevclass}>
                                      {list.prevclass}
                                    </option>
                                  ))}
                              </select>
