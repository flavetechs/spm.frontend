...
import { parentAssessmentLocations, parentTeachersNoteLocations } from '../../../router/parents-path-locations';
                ...
                <Card style={{ width: '16rem' }}>
                  ...
                  <Card.Body >
                    ...
                    <Link
                      ...
                      to={`${parentAssessmentLocations.parentAssessmentView}?classId=${item.classId}&studentId=${item.studentId}&ward=${item.fullnaName}`}
                    >
                      View Assessment
                    </Link>
                  </Card.Body>
