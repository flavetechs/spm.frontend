            ...
            <Card>
              <Card.Header className="d-flex justify-content-between">
                <div className="header-title">
                  <h4 className="card-title mb-3 text-uppercase">
                    <b>Wards List</b>
                  </h4>
                </div>
              </Card.Header>
                    ...
                    <tbody>
                      {myWardList?.map((ward, idx) => (
                        <tr key={idx}>
                          ...
                          <td className="text-uppercase">
                            <b>{ward.registrationNumber}</b>
                          </td>
                          <td className="text-uppercase">
                            <b>{ward.class}</b>
                          </td>
                          <td className="text-uppercase">
                            <b>{ward.status === "Active" ? <Badge bg="success">Active</Badge> :
                              <Badge bg="danger">Inactive</Badge>
                            }</b>
                          </td>
                          <td className="text-uppercase">
                            <b>{ward.enrollmentStatus}</b>
                          </td>
                          <td>
