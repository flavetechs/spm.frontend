...
import { getResultSetting, getSchoolSetting } from "../../../../store/actions/portal-setting-action";
...
import "../../../students-area/Printing/result-templates/template.scss"

const ParentTemplateTwo = (props) => {
...
export default ParentTemplateTwo;
