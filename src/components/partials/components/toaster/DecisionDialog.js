...
import { respondToDeleteDialog, showHideDialog, showSingleDeleteDialog } from '../../../../store/actions/toaster-actions';

export const DecisionDialog = () => {
    const state = useSelector((state) => state);
    const dispatch = useDispatch();
    const { dialogShow: show , message} = state.alert;
    return (
