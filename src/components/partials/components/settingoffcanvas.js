...
import { getAppLayout, getAppLayout2, updateAppLayout } from '../../../store/actions/portal-setting-action'
...
const SettingOffcanvas = (props) => {
    ...
    useEffect(() => {
        ...
        getAppLayout2(schoolUrl)(dispatch)
    }, [schoolUrl])
                        ...
                        <Col lg={12}>
                            ...
                            <div className="grid-cols-2 mb-4 d-grid gap-x-3">
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-1' ? 'active' : ''} btn btn-border mb-4 `} onClick={() => {
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-2' ? 'active' : ''} btn btn-border mb-4 `} onClick={() => {
                                        showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-3' ? 'active' : ''} btn btn-border mb-4 `} onClick={() => {
                                        showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-4' ? 'active' : ''} btn btn-border mb-4 `} onClick={() => {
                                        showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'default-login-template' ? 'active' : ''} btn btn-border mb-4 `} onClick={() => {
                                        showHideLoginLayoutModal(true)(dispatch);
