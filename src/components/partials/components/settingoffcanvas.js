    ...
    return (
        <>
            ...
            <Offcanvas show={show} onHide={() => {
                handleClose();
                console.log('colorcustomizerMode', colorcustomizerMode);
                updateAppLayout(
                    {
                        ...
                        <Col lg={12}>
                            ...
                            <div className="grid-cols-2 mb-4 d-grid gap-x-3">
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-1' ? 'active' : ''} btn btn-border mb-4 `}
                                        onClick={() => {
                                            props.LoginTemplateAction('template-1');
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-2' ? 'active' : ''} btn btn-border mb-4 `}
                                        onClick={() => {
                                            props.LoginTemplateAction('template-2');
                                            showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-3' ? 'active' : ''} btn btn-border mb-4 `}
                                        onClick={() => {
                                            props.LoginTemplateAction('template-3');
                                            showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'template-4' ? 'active' : ''} btn btn-border mb-4 `}
                                        onClick={() => {
                                            props.LoginTemplateAction('template-4');
                                            showHideLoginLayoutModal(true)(dispatch);
                                ...
                                <div className='d-flex'>
                                    <div className={`${props.loginTemplateMode === 'default-login-template' ? 'active' : ''} btn btn-border mb-4 `}
                                        onClick={() => {
                                            props.LoginTemplateAction('default-login-template');
                                            showHideLoginLayoutModal(true)(dispatch);
