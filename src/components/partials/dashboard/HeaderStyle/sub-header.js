...
import { admissionLocations, notificationManagement, sessionLocations } from '../../../../router/spm-path-locations'
                        ...
                        <Col md="12">
                            <div className="d-flex justify-content-between flex-wrap">
                                ...
                                <div className="d-flex align-items-center">
                                        <Link to={admissionLocations.admissionRegistration} className="btn btn-link btn-soft-light">
