...
import { announcementLocations, dashboardLocations, myWardsLocations, parentAssessmentLocations, parentTeachersNoteLocations, printResultLocations, timeTableLocations, wardsNoteLocations } from '../../../../router/parents-path-locations'
