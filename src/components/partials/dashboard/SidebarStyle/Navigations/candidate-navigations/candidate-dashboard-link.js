    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === candidateLocations.candidateList ? 'active' : ''} nav-link `} aria-current="page" to={candidateLocations.candidateList} onClick={props.minisidebar}>
                        <i className="icon">
