    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === studentPrintResultLocations.printResult ? 'active' : ''} nav-link `} aria-current="page" to={studentPrintResultLocations.printResult} onClick={props.minisidebar}>
                        <i className="icon">
