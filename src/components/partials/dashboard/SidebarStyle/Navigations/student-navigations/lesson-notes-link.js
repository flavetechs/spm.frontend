    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === lessonNoteLocations.lessonNotes ? 'active' : ''} nav-link `} aria-current="page" to={lessonNoteLocations.lessonNotes} onClick={props.minisidebar}>
                        <i className="icon">
                        ...
                        <span className="item-name">Lesson Note</span>
                    </Link>
                </li>
        </>
    )
