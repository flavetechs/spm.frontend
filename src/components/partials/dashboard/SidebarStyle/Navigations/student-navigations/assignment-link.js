...
import { assignmentLocations } from '../../../../../../router/students-path-locations'
export function AssignmentLink(props){
    var location = useLocation()
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === assignmentLocations.assignment ? 'active' : ''} nav-link `} aria-current="page" to={assignmentLocations.assignment} onClick={props.minisidebar}>
                        <i className="icon">
