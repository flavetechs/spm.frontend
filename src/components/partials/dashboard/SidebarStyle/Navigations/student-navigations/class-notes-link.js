    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === classNoteLocations.classNotes ? 'active' : ''} nav-link `} aria-current="page" to={classNoteLocations.classNotes} onClick={props.minisidebar}>
                        <i className="icon">
