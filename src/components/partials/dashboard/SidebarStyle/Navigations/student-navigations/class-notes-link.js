...
export function ClassNoteLink(props){
    var location = useLocation()
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === studentClassNoteLocations.classNotes ? 'active' : ''} nav-link `} aria-current="page" to={studentClassNoteLocations.classNotes} onClick={props.minisidebar}>
                        <i className="icon">
                        ...
                        <span className="item-name">Class Note</span>
                    </Link>
                </li>
        </>
    )
