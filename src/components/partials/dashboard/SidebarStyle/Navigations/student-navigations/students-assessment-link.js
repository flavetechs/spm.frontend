    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === studentAssessmentLocations.assessment ? 'active' : ''} nav-link `} aria-current="page" to={studentAssessmentLocations.assessment} onClick={props.minisidebar}>
                        <i className="icon">
