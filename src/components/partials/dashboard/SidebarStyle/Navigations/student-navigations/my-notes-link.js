    ...
    return(
        <>
         <li className="nav-item">
                    <Link className={`${location.pathname === studentNoteLocations.studentNotes ? 'active' : ''} nav-link `} aria-current="page" to={studentNoteLocations.studentNotes} onClick={props.minisidebar}>
                        <i className="icon">
                        ...
                        <span className="item-name">My Note</span>
                    </Link>
                </li>
        </>
    )
