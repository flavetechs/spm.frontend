...
const CumulativeMasterListSmallTable = ({
  cumulativeEntry,
      ...
      <div>
        ...
        <Row className="pt-3">
          ...
          >
            <tbody>
              <tr>
                <th className="h6" style={{ border: "1px solid grey" }}>
                  Session
                </th>
                <th
              ...
              <tr>
                ...
                <th
                  className="fw-bold text-capitalize h6"
                  style={{ border: "1px solid grey", fontWeight: "600" }}
                >
                  {cumulativeEntry?.sessionClass}
                </th>
              </tr>
              <tr>
                <th className="h6" style={{ border: "1px solid grey" }}>
