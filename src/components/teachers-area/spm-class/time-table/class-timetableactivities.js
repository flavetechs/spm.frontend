                        ...
                        {modal == 'newDayModal' ?
                            ...
                            /> : modal == 'newTimeModal' ?
                                <NewTimeModal
                                    ...
                                    selectedClassId={selectedClassId}
                                /> :
                                modal == 'updateDayModal' ? <UpdateDayModal selectedClassId={selectedClassId} timetableList={timetableList} currentDay={currentDay} timetableDayId={timetableDayId}/> :
                                    modal == 'updateTimeModal' ? <UpdateTimeModal timetableList={timetableList} selectedClassId={selectedClassId} currentPeriod={currentPeriod} timetableTimeId={timetableTimeId}
                                    /> :
