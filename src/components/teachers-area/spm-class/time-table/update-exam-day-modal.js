...
import { updateExamTimetableDays } from "../../../../store/actions/timetable-actions";
import { respondModal, showHideModal } from "../../../../store/actions/toaster-actions";

export function UpdateExamDayModal({ selectedTimetable, selectedClassId, currentDay, timetableDayId }) {
    ...
    const handeSubmit = () => {
        if (!newDay.trim()) {
            ...
            updateExamTimetableDays(newDay, selectedTimetable?.examTimeTableId, timetableDayId, selectedClassId)(dispatch);
