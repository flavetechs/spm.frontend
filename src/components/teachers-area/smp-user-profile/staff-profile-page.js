                    ...
                    <Card>
                        ...
                        <div className="card-body ">
                            <div>
                                ...
                                <h5 className="d-flex justify-content-center text-dark bg-light">{selectedItem?.fullName}</h5>
                                <hr />
                                <div className="mt-3 text-dark">
                                    <p className="mb-1 text-dark fw-bold">Biography :</p>
                                ...
                                <div className="">
                                    {selectedItem?.hobbies.map((item, index) => (
                                        <div className="tag-item bg-light m-1 text-dark text-capitalize" key={index}>
                                            ...
                                            {item ? <span className="p-1 text-dark">
                                            ...
                                            <div className="mb-2">
                                                ...
                                                <dl>
                                                    {teacherClassesAndSubjects?.classesAsFormTeacher.map((item, index) => {
                                                        return (
                                                            <div className="text-dark" key={index}><dt>{item.class}</dt>
                                            ...
                                            <div className="mb-2">
                                                ...
                                                <dl>
                                                    {teacherClassesAndSubjects?.subjectsAsSubjectTeacher.map((item, index) => {
                                                        return (
                                                            <div className="text-dark" key={index}><dt>{item.subject}</dt>
