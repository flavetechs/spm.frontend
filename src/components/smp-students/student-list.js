            ...
            <Card>
              <Card.Header className="d-flex justify-content-between">
                <div className="header-title">
                  <h4 className="card-title"><b>Students List</b></h4>
                </div>
              </Card.Header>
                    ...
                    <tbody>
                      {studentList.map((student, idx) => (
                        <tr key={idx}>
                          ...
                          <td className="text-uppercase"><b>{student.sessionClass}</b></td>
                          <td className="text-uppercase"><b>{student.registrationNumber}</b></td>
