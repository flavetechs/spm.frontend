...
import { getAllResultList, updatePublishedResult } from "../../store/actions/publish-actions";
          ...
          {publishedButton ? (
            <Button
              ...
              onClick={() => {
                ...
                getAllResultList(idsObj?.sessionClassId, selectedSession?.sessionTermId,)(dispatch);
...
>>>>>>> 4bf8e814bc473c93eb8a1fc50a16ce6586a05ec7
                    <OverlayTrigger
                      placement="top"
