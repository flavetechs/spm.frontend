                        ...
                        <Table size="md" hover bordered responsive className="mt-2">
                            <thead>
                                <tr className="text-center" style={{ background: '#d8efd1' }}>
                                    ...
                                    <th className="text-uppercase h6 text-start">Students Full Name</th>
                                    <th className="text-uppercase h6 text-start">Student Registration No</th>
                                    <th className="text-uppercase h6">Position</th>
                                    <th className="text-uppercase h6">Average Score</th>
                                    <th className="text-uppercase h6 px-2">Total No. of <br />Subject offered</th>
                                        ...
                                        >
                                            ...
                                            <td>
                                                <div className="flex align-items-center list-user-action">
                                                    <OverlayTrigger
                                                        placement="top"
                                                        overlay={<Tooltip id="button-tooltip-2"> Preview Result</Tooltip>}
                                                    >
                                                        <Link
