      ...
      <div className="container">
        <Row>
          <Col sm="12">
            <Card>
              <Card.Header
                className="d-md-flex justify-content-between border border-light"
                      ...
                      <tbody>
                        {filteredCandidateList.map((student, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="text-uppercase">
                              <b>
                                {student.candidateAdmissionStatus == 0 ? (
                              ...
                              <div className="flex align-items-center list-user-action">
                                ...
                                >
                                  <Link
                                    ...
                                    onClick={() => {
                                      dispatch(pushId(student.admissionId));
                                      deleteDialogModal(student.admissionId)(
                                        dispatch
                                      );
                                    }}
                                  >
